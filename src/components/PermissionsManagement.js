...
const PermissionManagement = () => {
  ...
  const addPermission = () => {
    if (
      !permissions.some(
        (perm) =>
          perm.user === newPermission.user &&
          perm.role === newPermission.role &&
          perm.permission === newPermission.permission
      )
    ) {
  ...
  return (
    <div className="permission-management">
      ...
      <Dialog open={deleteIndex !== null} onClose={() => setDeleteIndex(null)}>
        ...
        <DialogActions>
          <Button onClick={() => setDeleteIndex(null)} color="secondary">
            Cancel
          </Button>
          <Button onClick={deletePermission} color="error">
            Delete
          </Button>
        </DialogActions>
      </Dialog>
